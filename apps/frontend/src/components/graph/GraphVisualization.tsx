  ...
  return (
    <div className={`relative ${className}`} style={{ height }}>
      ...
      <div
        ...
        className="w-full h-full bg-grove-canvas dark:bg-grove-canvas-dk rounded-lg border border-grove-border dark:border-grove-border-dk relative overflow-hidden"
        style={{
          backgroundImage: `
